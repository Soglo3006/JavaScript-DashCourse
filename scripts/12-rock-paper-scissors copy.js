...
function play() {
    const playElement = document.querySelector('.js-button-play');


    if (playElement.innerHTML === 'Auto Play' && !isAutoPlay) {
        playElement.innerHTML = 'Stop Play';
        intervalID = setInterval(autoPlay, 1000);
        isAutoPlay = true;
    } else if (playElement.innerHTML === 'Stop Play') {
